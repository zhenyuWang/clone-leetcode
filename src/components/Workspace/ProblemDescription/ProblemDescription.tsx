...
type ProblemDescriptionProps = { problem: Problem; _solved: boolean }
            ...
            <div className='mt-4'>
              {problem.examples.map((example, index) => (
                <div key={example.id}>
                  ...
                  {example.img && <Image src={example.img} alt='' width={600} height={100} className='mt-3' />}
